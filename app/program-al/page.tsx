...
const schema = z.object({
  ...
  age: z.preprocess(v => Number(v), z.number().min(15).max(80)),
  weight: z.preprocess(v => Number(v), z.number().min(40).max(200)),
  height: z.preprocess(v => Number(v), z.number().min(140).max(220)),
